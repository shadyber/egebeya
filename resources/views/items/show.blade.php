...
@section('content')
    ...
    <section class="product-section">
        <div class="container">
            <div class="back-link">
                <a href="/item"> &lt;&lt; Back to Category</a>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="product-pic-zoom">
                        <img class="product-big-img" src="{{$item->photo}}" alt="{{$item->name}}">
                    </div>
                    <div class="product-thumbs" tabindex="1" style="overflow: hidden; outline: none;">
                        <div class="product-thumbs-track">
                            <div class="pt active" data-imgbigurl="{{$item->photo}}"><img src="{{$item->photo}}" alt="{{$item->name}}"></div>
                ...
                <div class="col-lg-6 product-details">
                    ...
                    <h3 class="p-price">${{$item->price}} ETB</h3>
